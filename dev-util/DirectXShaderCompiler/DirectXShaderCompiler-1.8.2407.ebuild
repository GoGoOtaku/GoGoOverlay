...
pkg_postinst() {
	ewarn "This version is a copy of the guru package!"
	ewarn "I ship it to only ihave a hard dependency on base gentoo."
	ewarn "It is recommended to install the guru version of this package instead"
}
